...
const Header = ({ onOpenContact }: HeaderProps) => {
    ...
    return (
        <header
            className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ease-soft-out pt-4 px-4`}
        >
            <div
                className={`
          mx-auto transition-all duration-300 ease-soft-out
                                ...
                                return (
                                    <Magnetic key={link.label} strength={0.2}>
                                        <RippleButton
                                            ...
                                            className={`
                        relative px-6 py-2 rounded-full text-sm font-semibold transition-all duration-150 ease-bounce-low
                        ${isActive
